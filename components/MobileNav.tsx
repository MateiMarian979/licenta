    ...
    <section className="w-full max-w-[264px]">
        <Sheet>
            ...
            <SheetContent side="left" className="border-none bg-white">
                ...
                <h1 className="text-26 font-bold text-black-1">BankApp</h1>
                </Link>
                <div className="mobilenav-sheet">
                    <SheetClose asChild>
                        ...
                        {sidebarLinks.map(
                            (item) => {
                                const isActive = pathName === item.route || pathName.startsWith(`${item.route}/`) // avem styling activ daca suntem pe
                                                                                                                // anumite pathuri
